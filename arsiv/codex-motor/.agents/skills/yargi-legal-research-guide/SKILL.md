...
Bu kılavuz `.Codex/skills/yargi-legal-research-guide/SKILL.md` olarak kaydedilmiştir (sürüm 2026-07-08b). `legal_research_guide` tool'unun açıklaması daha YENİ bir sürüm ilan ederse tool'u bir kez çağırıp bu dosyanın üzerine yaz; aynı ya da eskiyse tool'u ÇAĞIRMA, bu skill'i kullan.
